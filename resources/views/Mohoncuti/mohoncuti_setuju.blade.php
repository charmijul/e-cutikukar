    ...
    <div class="card">
        <div class="row mt-3 justify-content-center" style="border-radius: 10px;">
            <div class="container col-md-6">
                <form action="/cuti-setuju" method="GET">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Lama Cuti</th>
                            <th>Approval Atasan Langsung</th>
                            <th>Approval Atasan Berwenang</th>
                        ...
                        @if (auth()->user()->id_pegawai == $p->atasan->langsung ||
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <label class="label label-success" style="background-color: green; padding: 5px; border-radius: 5px; color: white;">disetujui</label>
                                </td>
                                <td style="text-align: center;">
                                    <label class="label label-success" style="background-color: green; padding: 5px; border-radius: 5px; color: white;">disetujui</label>
                                </td>
